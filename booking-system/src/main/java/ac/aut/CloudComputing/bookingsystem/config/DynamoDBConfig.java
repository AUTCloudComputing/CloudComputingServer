...
/*
	...
	*/
	...
	/*
	 * @Bean(name = "mvcHandlerMappingIntrospectorCustom") public
	 * HandlerMappingIntrospector mvcHandlerMappingIntrospectorCustom() { return new
	 * HandlerMappingIntrospector(context); }
	 */
}